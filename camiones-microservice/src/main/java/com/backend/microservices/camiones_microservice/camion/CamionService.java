...
public class CamionService {
    ...
    public CamionResponse getCamionById(Integer id){
        Camion camion = camionRepository.findById(id).orElseThrow(()-> new CamionException("Camion no encontrado con ese id"));
